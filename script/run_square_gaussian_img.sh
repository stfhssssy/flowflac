...
export DPPO_LOG_DIR="${DPPO_LOG_DIR:-${REPO_DIR}/log}"
export DPPO_DATA_DIR="${DPPO_DATA_DIR:-${REPO_DIR}/data}"
...
export DPPO_WANDB_ENTITY="${DPPO_WANDB_ENTITY:-${SQUARE_WANDB_ENTITY}}"
