...
TEE_LOG="/tmp/flac_transport_img_multistep_bridge_u4_actor4_fixedstart_noz_tb008_stableq_${RUN_TAG}.log"
...
python3 script/run.py \
  ...
  name=transport_ft_flac_multistep_bridge_reflow_mlp_img_s4_u4_actor4_fixedstart_noz_tb008_stableq_seed42 \
  env.n_envs=50 \
