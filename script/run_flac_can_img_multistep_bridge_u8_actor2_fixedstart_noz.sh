...
TEE_LOG="/tmp/flac_can_img_multistep_bridge_u8_actor2_fixedstart_noz_${RUN_TAG}.log"
...
python3 script/run.py \
  ...
  name=can_ft_flac_multistep_bridge_reflow_mlp_img_s4_u8_actor2_fixedstart_noz_seed42 \
  env.n_envs=50 \
