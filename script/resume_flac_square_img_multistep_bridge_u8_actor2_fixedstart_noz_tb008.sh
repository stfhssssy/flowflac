...
RUN_DIR="${REPO_DIR}/log/robomimic/finetune/square_ft_flac_multistep_bridge_reflow_mlp_img_s4_u8_actor2_fixedstart_noz_tb008_seed42/2026-05-22_22-37-51_42"
RESUME_PATH="${RUN_DIR}/checkpoint/last.pt"
RUN_TAG="$(date +%Y%m%d_%H%M%S)_$$"
TEE_LOG="/tmp/resume_flac_square_img_multistep_bridge_u8_actor2_fixedstart_noz_tb008_${RUN_TAG}.log"
...
python3 script/run.py \
  ...
  name=square_ft_flac_multistep_bridge_reflow_mlp_img_s4_u8_actor2_fixedstart_noz_tb008_seed42 \
  logdir="${RUN_DIR}" \
