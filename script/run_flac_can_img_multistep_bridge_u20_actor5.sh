...
TEE_LOG="/tmp/flac_can_img_multistep_bridge_u20_actor5_${RUN_TAG}.log"
...
python3 script/run.py \
  ...
  name=can_ft_flac_multistep_bridge_reflow_mlp_img_s4_u20_actor5_alpha1e4_noise03_v03_seed42 \
  env.n_envs=50 \
  ...
  train.updates_per_step=20 \
  train.actor_update_interval=5 \
  train.actor_lr=3e-6 \
