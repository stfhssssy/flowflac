...
TEE_LOG="/tmp/flac_square_img_multistep_bridge_u4_actor4_fixedstart_noz_tb012_stableq_${RUN_TAG}.log"
...
python3 script/run.py \
  ...
  name=square_ft_flac_multistep_bridge_reflow_mlp_img_s4_u4_actor4_fixedstart_noz_tb012_stableq_seed42 \
  env.n_envs=50 \
  ...
  train.alpha_lr=1e-4 \
  train.target_bridge_energy=0.012 \
  train.target_kinetic=0.012 \
